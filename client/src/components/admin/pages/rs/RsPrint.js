...
export const RsPrint = React.forwardRef((props, ref) => {
  //  FLIGHT DETAILS
      ...
      <Box sx={{ flexGrow: 1, fontSize: 11.3 }}>
        <Grid container spacing={1} columns={16}>
          ...
          <Grid item xs={3.5} sx={{ fontSize: 13 }}>
            ...
            <div>{props.booking.booking_no}</div>
            <div>
          ...
          {props.booking.customer.customer_type === "WALK IN" ? (
            ...
            <Grid item xs={16} sx={{ fontSize: 15 }}>
              ...
              <div>
                {" "}
                Handler:{" "}
                {props.booking.handler_by.first_name +
                  " " +
                  props.booking.handler_by.last_name}
              </div>
              <div> Prepared By: {props.booking.encode_by.name}</div>
            </Grid>
          )}
          <Grid item xs={16}>
            <Divider
          ...
          {/*  DATA */}
          {props.booking.product_service.map((item, index) => {
            return (
              <>
                <Grid item xs={16}>
                  <Divider
                ...
                {item.prod_serv_type === "FLIGHT" && (
                  <>
                    ...
                    {props.booking.product_service_compute
                      ...
                      return (
                        <>
                          ...
                          <Grid item xs={10} style={{ textAlign: "right" }}>
                            ...
                            <b>
                              <NumberFormat
                                value={parseFloat(e.total_cost_in_php).toFixed(
                                  2
                                )}
                                displayType={"text"}
                                thousandSeparator={true}
                            ...
                            <b>
                              <NumberFormat
                                value={parseFloat(e.total_cost_in_usd).toFixed(
                                  2
                                )}
                                displayType={"text"}
                                thousandSeparator={true}
          ...
          <Grid item xs={10} style={{ textAlign: "right" }}>
            <b>
              <NumberFormat
                value={parseFloat(
                  props.booking.grand_total_cost.grand_total_cost_in_php
                ).toFixed(2)}
                displayType={"text"}
                thousandSeparator={true}
                prefix={"₱ "}
              ...
              <NumberFormat
                value={parseFloat(
                  props.booking.grand_total_cost.grand_total_cost_in_usd
                ).toFixed(2)}
                displayType={"text"}
                thousandSeparator={true}
                prefix={"$ "}
          ...
          <Grid item xs={10} style={{ textAlign: "right" }}>
            <b>
              <NumberFormat
                value={parseFloat(
                  props.booking.grand_total_selling.grand_total_selling_in_php -
                    props.booking.grand_total_cost.grand_total_cost_in_php
                ).toFixed(2)}
                displayType={"text"}
                thousandSeparator={true}
              ...
              <NumberFormat
                value={parseFloat(
                  props.booking.grand_total_selling.grand_total_selling_in_usd -
                    props.booking.grand_total_cost.grand_total_cost_in_usd
                ).toFixed(2)}
                displayType={"text"}
                thousandSeparator={true}
